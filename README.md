...
### 주차별 학습
| <div style="width:290px">주차</div> | <div style="width:290px">기간</div> | 주제 | 수행 과정 및 결과 |
|:-----:|:-----:|:-----:|:-----:|
| 1주 | 08-03 ~ 08-07 | 딥러닝 환경 구성 | 개인 노트북에 GPU가 없기에 윈도우 환경에서 MobaXterm을 통해 KIRO 8 GPU 서버 연결 |
| 2주 | 08-10 ~ 08-14 | 데이터셋 구축 1차 | 데이터셋 구축 장비 준비가 늦춰지면서, 3주차와 순서를 바꿈. Image Classification 조사(LeNet, AlexNet, VGGNet, GoogLeNet, ResNet) |
| 3주 | 08-18 ~ 08-21 | Image Classification 기술 조사|Image Classification 기술 조사(PreActResNet ~ NASNet), 데이터셋 구축 중..(08/19 - 1,000장 완료) |
| 4주 | 08-24 ~ 08-28 | 데이터셋 구축 2차 | |
| 5주 | 08-31 ~ 09-04 | Object Detection  기술 조사 | |
| 6주 | 09-07 ~ 09-11 | Face Detection  기술 조사 | |
| 7주 | 09-14 ~ 09-18 | 기존 모델  다루기 실습 | |
| 8주 | 09-21 ~ 09-25 | Transfer Learning  준비 | |
| 9주 | 09-28 ~ 09-29 | Transfer Learning  실습 | |
| 10주 | 10-05 ~ 10-08 | 결과 검토 및 모델 수정 | |
| 11주 | 10-12 ~ 10-16 | GUI 개발 | |
| 12주 | 10-19 ~ 10-23 | 기술별 보완 | |
| 13주 | 10-26 ~ 10-30 | 추론기 제작 | |
| 14주 | 11-02 ~ 11-06 | 동작 시험 및 디버깅 | |
| 15주 | 11-09 ~ 11-13 | 발표 준비 및 최종 발표 | |
<br><br>
